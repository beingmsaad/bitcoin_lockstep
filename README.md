...
make install Bitcoin
install nodejs and npm
open scripts directory
Bitcoin.conf file is provided in this directory. Replace your Bitcoin.conf with the given file and set RPC username and password
...
make a directory to store the output of reachable.js
make a directory to store the output of goodnodes.js
